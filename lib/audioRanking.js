...
// Sonos Arc/Beam — DD+ Atmos only; no lossless or DTS family.
const SONOS_FRIENDLY_ORDER = [
  'atmos', 'ddplus', 'dd', 'aac', 'other',
];
...
const DEVICE_PRESETS = [
  ...
  { id: 'sonos',      label: 'Sonos (Arc/Beam)',        supports: ['atmos','ddplus','dd','aac','other'],
    note: 'Hides DTS:X, TrueHD, DTS-HD MA, LPCM, FLAC, DTS — Atmos via DD+ only' },
...
const COMBO_PRESETS = [
  ...
  { id: 'shield_sonos',  label: 'Shield → Sonos',       kind: 'combo', combo: ['shield', 'sonos'],
    ...
    note: 'DD+ / Atmos for Sonos; lossless & DTS family hidden' },
