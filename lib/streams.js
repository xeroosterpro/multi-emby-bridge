...
async function getAllStreams(servers, type, imdbId, season, episode, opts = {}) {
  const { sortOrder, excludeRes, recommend, ping, audioLang, maxBitrate, prefCodec, codecMode, labelPreset, pingDetail, autoSelect, qualityBadge, flagEmoji, bitrateBar, subsStyle, customNameFields, customDescFields, audioRank, audioOrder, audioDisabled, audioRankMode, audioDisableAction, surroundPriority } = opts;
