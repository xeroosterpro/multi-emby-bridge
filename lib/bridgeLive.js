...
// not necessarily playing it. Keep the inferred-live window short so a browse a
// few minutes ago stops masquerading as an active stream.
const DEFAULT_BRIDGE_LIVE_MS = 3 * 60 * 1000;
